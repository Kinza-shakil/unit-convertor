...
st.markdown(
   ...
   .stbutton>button {
       ...
       color: linear-gradient(135deg, rgb(75, 19, 64), rgb(22, 45, 65));
       font-size: 18px;
       padding: 10px 20px;
       border-radius: 10px;
   ...
   .stbutton>button:hover {
       background-color: linear-gradient(45deg, rgb(63, 17, 137), rgb(87, 17, 52));
   ...
   .result-box {
       ...
       border-radius: 10px;
       margin-top: 20px;
       box-shadow: 0px 5px 15px rgba(64, 14, 48, 0.3);
   }
   .footer {
       text-align: center;
       margin-top: 50px;
...
# Footer
st.markdown("<div class='footer'>Created with love 💌by Kinza Shakil</div>", unsafe_allow_html=True)
